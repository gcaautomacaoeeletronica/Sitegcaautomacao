        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 lg:gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <a href={`https://wa.me/${(global?.whatsappNumber || global?.whatsapp || '5519971206717').replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 bg-white/5 rounded-2xl border border-white/5 hover:bg-white/10 hover:border-white/10 transition-all duration-300 group">
