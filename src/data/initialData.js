...
export const SITE_CONTENT_DEFAULT = {
  global: {
    ...
    cep: "13472-370",
    googleVerificationCode: "sIaVsdL0NOIaX9eyw6rCD_tBZP6fMcj2677CQ50wVAM",
...
export const SITE_MEDIA_DEFAULT = {
  ...
  aboutSide: { url: '', link: '' },
  services: { url: '', link: '' },
  servicesGallery_0: { url: '', link: '', title: '', desc: '' },
  servicesGallery_1: { url: '', link: '', title: '', desc: '' },
  servicesGallery_2: { url: '', link: '', title: '', desc: '' },
  servicesGallery_3: { url: '', link: '', title: '', desc: '' },
  servicesGallery_4: { url: '', link: '', title: '', desc: '' },
  servicesGallery_5: { url: '', link: '', title: '', desc: '' },
